...
//       if (isYoutube(url)) {
//         const doc = document.querySelector("ytd-video-primary-info-renderer");
//         handleYoutubePageLoad(doc);
//       }
...
//   const handleYoutubePageLoad = (doc) => {
//     const title = document.title;
//     const head = document.head;
//     const description = head.querySelector('meta[name="description"]');
//     const keyword = head.querySelector('meta[name="keywords"]');

//     console.log("Loaded YouTube page", { title, description, keyword });
//   };

//   const handleMessage = async (message) => {
//     if (message.action === "bookmarkSaved") {
//       const ytLink = message?.data?.link ? message.data.link : message.data.url;
//       const cleanCompressedHTML = isYoutube(ytLink) ? "" : compressString(removeAllAttributesFromHTML(document.body.innerHTML));
...
//   const removeAllAttributesFromHTML = (html) => {
//     const tempContainer = document.createElement("div");
//     tempContainer.innerHTML = html;
...
//         if (!div.querySelector(".additional-button") && !processedPosts.has(postId)) {
//           const newButton = createLinkedInButton(postId, postElement);
//           div.append(newButton);
//           processedPosts.add(postId);
//         }
//       });
...
//   const createLinkedInButton = (postId, postElement) => {
//     const newButton = document.createElement("button");
//     newButton.innerHTML = `<img alt="" src="data:image/png;base64," />`;
//     newButton.style.borderRadius = "100%";
//     newButton.style.cursor = "pointer";
...
//       const postData = await fetchLinkedInPostData(postId, postElement);
//       console.log("postData", { postData });
...
//   const fetchLinkedInPostData = async (postId, postElement) => {
//     try {
//       const response = await axios.get(`https://www.linkedin.com/embed/feed/update/${postId}`);
//       const htmlString = response.data;
...
//   const extractLinkedInPostData = (document) => {
//     const postData = {};

//     const authorElement = document.querySelector('[data-test-id="main-feed-activity-card__header"] a');
//     if (authorElement) {
//       postData?.authorName = authorElement.innerText;
//       postData?.authorProfileLink = authorElement.href;
//     }

//     const contentElement = document.querySelector('[data-test-id="main-feed-activity-embed-card__commentary"]');
//     if (contentElement) {
//       postData?.content = contentElement.innerText;
//     }

//     const imageElement = document.querySelector('[data-test-id="feed-images-content__list-item"] img');
//     if (imageElement) {
//       postData?.imageUrl = imageElement.getAttribute("data-delayed-url").split("?")[0];
//     } else {
//       const videoElement = document.querySelector('[data-test-id="feed-shared-update-v2__video"]');
//       if (videoElement) {
//         postData?.videoUrl = videoElement.getAttribute("src");
//       }
//     }

//     const reactionsElement = document.querySelector('[data-test-id="social-actions__reaction-count"]');
//     if (reactionsElement) {
//       postData?.reactions = reactionsElement.innerText;
//     }

//     const commentsElement = document.querySelector('[data-test-id="social-actions__comments"]');
//     if (commentsElement) {
//       postData?.comments = commentsElement.innerText;
//     }
...
//   const addGiveSummaryButton = (url) => {
//     if (isYoutube(url)) {
//       const div = document.createElement("div");
//       div.innerHTML = `<button id="give-summary" style="position: fixed; bottom: 10px; right: 10px; padding: 10px 20px; background-color: #007bff; color: white; border: none; border-radius: 5px; cursor: pointer;">Give Summary</button>`;
...
//     if (link === "https://ai.soobati.com/dashboard/profile" || link === "http://localhost:3000/dashboard/profile") {
...
//       const root = createRoot(rootDiv);
//       root.render(<YoutubeButtons title={title} videoId={videoId} videoDetails={compressSubtitle} />);
//     } else {
...
//       {notification && <div>Bookmark saved!</div>}
//       <div>
//         <h1 style={{ fontSize: "1.5rem", fontWeight: "bold", color: "black" }}>Header</h1>
//       </div>
//     </div>
//   );
// };
